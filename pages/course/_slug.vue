<template>
  <div>
    ...
    <div class="container">
      ...
      <p v-if="course.description" class="intro mt-3">
        {{ course.description }}
      </p>
      ...
      <div
        class="onlineEnquiry d-flex justify-content-center align-items-center"
      >
        <a href="/contact">
      ...
      <div class="row">
        <div class="col-sm-12 col-lg-6 min">
          <div v-if="course.receive" class="attendees mb-4">
            ...
            <ul
              v-for="course in course.receive"
              :key="course.title"
              class="m-0"
            >
              <li class="mt-2">{{ course }}</li>
        ...
        <div class="col-sm-12 col-lg-6">
          <div v-if="course.outcomes" class="outcomes mb-4">
            ...
            <ul
              v-for="course in course.outcomes"
              :key="course.title"
              class="m-0"
            >
              <li class="mt-2">{{ course }}</li>
