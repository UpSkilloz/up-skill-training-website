        ...
        <b-col sm="12" md="6" lg="4" class="d-flex">
          <div class="featureItem align-self-stretch">
            <b-row>
              ...
              >
                <p>
                  Delivered by qualified trainers that hold a minimum
        ...
        <b-col sm="12" md="6" lg="4" class="d-flex">
          <div class="featureItem align-self-stretch">
            <b-row>
              ...
              >
                <p>
                  Invest in Sales training and watch as your business benefits
                  from a more productive sales team and happy customers.
                </p>
              </b-col>
            </b-row>
          </div>
        ...
        <b-col sm="12" md="6" lg="4" class="d-flex">
          <div class="featureItem align-self-stretch">
            <b-row>
              ...
              >
                <p>
                  A highly skilled sales team equals higher profits and a better
                  performing business.
                </p>
              </b-col>
            </b-row>
        ...
        <b-col sm="12" md="6" lg="4" class="d-flex">
          <div class="featureItem align-self-stretch">
            <b-row>
              ...
              >
                <p>
                  Investing in effective sales training guarantees an immediate
        ...
        <b-col sm="12" md="6" lg="4" class="d-flex">
          <div class="featureItem align-self-stretch">
            <b-row>
              ...
              >
                <p>
                  Training is interactive, fun and immersive giving participants
                  the opportunity to practice newly learnt skills so they return
                  to your business ready to sell!
                </p>
              </b-col>
            </b-row>
          </div>
      ...
      <b-row>
        <b-col class="guaranteeWrapper">
          ...
          <h2 class="text-center">
            We back up every training program with our 100% Money Back
            Guarantee.
          </h2>
          <p>
            If attendees are not 100% satisfied with the program, your
            investment will be fully refunded. That’s how confident we are in
